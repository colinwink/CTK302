...
function setup() {
  ...
  swat = loadImage('assets/swatter.png');
  bg = loadImage('assets/house.jpg');

  font = loadFont('assets/Barlow-ExtraBold.ttf')
...
function draw() {
  ...
  textAlign(CENTER);
  textFont(font);
  text("SWAT EM!", width/2, 260, windowWidth - 200, windowHeight - 200);
...
function Car() {
  ...
  this.display = function() {
    ...
    image(fly, this.pos.x, this.pos.y, 30, 45);
